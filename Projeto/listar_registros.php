...
<body>
    ...
    <label for="ramo">Ramo atual: <?php echo htmlspecialchars($ramo_selecionado); ?></label><br>
        ...
        function atualizarOpcoes(selectElement) {
            ...
            if (grupo === "A") {
                ...
                cargaSelect.innerHTML = `
                    ...
                    <option value="torneira_eletrica">Torneira Elétrica</option>
                    <option value="aquecedor_passagem">Aquecedor de Passagem</option>
                    <option value="ferro_eletrico">Ferro Elétrico</option>
                    <option value="fogao_eletrico">Fogão Elétrico</option>
                    <option value="maquina_secar_roupa">Máquina de Secar Roupa</option>
                    <option value="maquina_lavar_louca">Máquina de Lavar Louça</option>
                    <option value="forno_eletrico">Forno Elétrico</option>
